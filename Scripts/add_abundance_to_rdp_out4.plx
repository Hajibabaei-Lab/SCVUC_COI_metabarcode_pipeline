...
#Script to add read abundance for each sample from cat.denoised.table to ESV taxonomic assignments from the RDP classifier
#USAGE perl add_abundance_to_rdp_out4.plx cat.denoised.table cat.denoised.out
...
my $sample;
my $abund;
my $outfile = "rdp.cat.updated.csv";
my $idline;
my $seqID;
...
print OUT "GlobalESV,SampleName,ESVsize,Strand,Root,RootRank,rBP,SuperKingdom,SuperKingdomRank,skBP,Kingdom,KingdomRank,kBP,Phylum,PhylumRank,pBP,Class,ClassRank,cBP,Order,OrderRank,oBP,Family,FamilyRank,fBP,Genus,GenusRank,gBP,Species,SpeciesRank,sBP\n";
